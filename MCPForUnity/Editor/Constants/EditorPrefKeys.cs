namespace com.tgs.mcpforunity.editor.Constants
{
    ...
    internal static class EditorPrefKeys
    {
        ...
        internal const string EditorWindowActivePanel = "com.tgs.mcpforunity.editorWindow.ActivePanel";
        ...
        // secure store (com.tgs.mcpforunity.editor.Security.SecureKeyStore), never in EditorPrefs.
