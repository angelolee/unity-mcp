using System;
using System.IO;
using com.tgs.mcpforunity.editor.Services.AssetGen;
using com.tgs.mcpforunity.editor.Services.AssetGen.Http;
using com.tgs.mcpforunity.editor.Services.AssetGen.Providers;
...
namespace MCPForUnityTests.Editor.AssetGen
{
    ...
    public class AssetGenJobManagerTests
    {
        ...
        public void MissingKey_FailsImmediately()
        {
            ...
            com.tgs.mcpforunity.editor.Security.SecureKeyStore.OverrideForTests(new com.tgs.mcpforunity.editor.Security.EncryptedFileKeyStore(dir));
            try
            {
                AssetGenJob job = AssetGenJobManager.StartModelGeneration(Req());
                Assert.AreEqual(AssetGenJobState.Failed, job.State);
            ...
            {
                com.tgs.mcpforunity.editor.Security.SecureKeyStore.ResetForTests();
